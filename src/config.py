...
GUILD_ID = 1358089537942978610
GUILD_IDS = (1203198852195418172, 1358089537942978610)

A_THEME = 0x0000a0
B_THEME = 0x00a000

VALORS_THEME1 = 0x3001B2
VALORS_THEME1_1 = 0x1AA1DB
VALORS_THEME1_2 = 0x0A0A40
VALORS_THEME2 = 0xBF4FDB

LFG_PING_DELAY = 30*60
MATCH_PLAYER_COUNT = 10
STARTING_MMR = 900
BASE_MMR_CHANGE = 40
MOMENTUM_CHANGE = 0.025
MOMENTUM_RESET_FACTOR = 0.25
