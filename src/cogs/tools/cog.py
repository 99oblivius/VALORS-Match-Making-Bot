...
class ModCommands(commands.Cog):
    ...
    @nextcord.slash_command(name="role_message", description="Set a user's special stats message (only eligible for players who have reached Mythic!)", guild_ids=[*GUILD_IDS])
