...
Revision ID: 3b2a1e29f5bb
Revises: 
Create Date: 2024-06-19 06:32:30.018612
...
def upgrade() -> None:
    ...
    sa.Column('phase', sa.Enum('NONE', 'A_BAN', 'B_BAN', 'A_PICK', 'B_SIDE', name='phase'), nullable=False),
    ...
    sa.Column('a_mmr', sa.SmallInteger(), nullable=True),
    sa.Column('b_mmr', sa.SmallInteger(), nullable=True),
    ...
    sa.Column('match_id', sa.Integer(), nullable=False),
    sa.Column('map', sa.String(length=32), nullable=False),
    sa.Column('phase', sa.Enum('NONE', 'A_BAN', 'B_BAN', 'A_PICK', 'B_SIDE', name='phase'), nullable=True),
    sa.Column('timestamp', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['guild_id', 'user_id'], ['mm_bot_users.guild_id', 'mm_bot_users.user_id'], ),
    sa.ForeignKeyConstraint(['match_id'], ['mm_bot_matches.id'], ),
    sa.PrimaryKeyConstraint('guild_id', 'user_id', 'match_id')
